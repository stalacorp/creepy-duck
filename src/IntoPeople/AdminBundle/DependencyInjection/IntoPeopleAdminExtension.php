...
namespace IntoPeople\AdminBundle\DependencyInjection;
 ...
 */
class IntoPeopleAdminExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        /*
            ...
            Will internally get converted to an 'into_people_admin_profile' form-type service definition.
            Never set the template namespace to FOSUserBundle or RollerworksMultiUserBundle as this will create an endless recursion!
        */

        $factory->create('into_people_admin', array(
            array(
                /*
                ...
                /*
                'group' => array(
                    'group_class' => 'IntoPeople\AdminBundle\Entity\Group',
